...
> 公开版已移除公司、客户、项目、地点、内部系统、账号、路径、真实问题、日志与其他可识别信息。仓库中的案例均为重新组合的虚构示例。
...
>
> 我把边界看作服务当前决策的临时假设，而不是永恒正确的分类。向外、向内和横向移动，是为了保留真正影响行动的关系。
>
> 我认为创新不是把更多东西堆在一起，而是理解差异、舍弃噪音，再重新组织出一个自洽的新解法。
>
